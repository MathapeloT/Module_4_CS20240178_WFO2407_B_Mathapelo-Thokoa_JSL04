...
console.log(`The user prefers is ${userPreference === undefined ? "an undefined" : "a " + userPreference} variety`);
...
console.log(`${currentTemp <= 5 ? "Chilled to perfection!" : "Needs a cooler ASAP!"}`);
...
console.log(`${currentHour >= 5 && currentHour <= 24 ? "Unleash the beast!" : "Better stick to water"}`);
