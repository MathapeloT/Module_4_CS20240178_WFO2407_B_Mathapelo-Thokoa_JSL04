...
let user = userPreference === "Sugar-free" ? "Sugar-free" : "Regular";
...
let cansLeft = "3";
let stockCheck = cansLeft === "3" ? "3" : "7";

console.log(stockCheck = cansLeft < 5 ? "Time to restock!" : "We're stocked")
...
let heartRate = 95;
let checkHeartRate = 95 ? 95 : 120;

console.log(checkHeartRate = heartRate < 100 ? "Boost Needed!" : "Energy levels are high!")
...
let currentTemp = 10;
let checkTemp = 10 ? 10 : 2;

console.log(checkTemp = currentTemp < 5 ? "Chilled to perfection!" : "Needs a cooler ASAP!")
...
const period = currentHour < 10 ? '0${currentHour}' : currentHour;

console.log("Current hour is:", formattedHour)

// Write your code below this line to determine if it's a good idea to have a Monster Energy drink based on the current hour
// If it's between 7am and midnight (24-hour format), print "Unleash the beast!"
// Otherwise, print "Better stick to water."

let timeCheck = currentHour >= 7 && currentHour <= 24;

console.log(timeCheck = currentHour >= 7 && currentHour <= 24 ? "Unleash the beast!" : "Better stick to water!")
